...
vendedor VARCHAR(50), cantarticulos INT NOT NULL, subtotal INT NOT NULL,
...
INSERT INTO clientes (idcliente,`nombres`, `apellidos`, `telefono`) VALUES (4,'Fernando', 'Lara', '967867366');
INSERT INTO clientes (idcliente,`nombres`, `apellidos`, `telefono`) VALUES (5,'Andrea', 'Varas', '975677256');
...
SELECT idcliente,nombres,apellidos FROM clientes WHERE direccion IS NULL;

-- 5. saber, al mismo tiempo, monto de venta mínima y máxima registrada en tabla respectiva.
SELECT MAX(total) AS VentaMáxima,MIN(total) AS VentaMínima
FROM ventas; 
